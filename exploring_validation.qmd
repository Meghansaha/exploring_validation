...
## {.trans background-color="#ffffff" background-image="images/trans1.png"}


<h1><span style="color: #ffffff;"><center>What is Validation?<br>and Why Do We Care?</center></span></h1>
...
## {.transdark background-color="#333333" background-image="images/trans2.png"}


<h1><span style="color: #000000;"><center>Different Types<br>of Validations</center></span></h1>
...
## {.trans background-color="#ffffff" background-image="images/trans3.png" background-size="80%"}


<h1><span style="color: #ffffff;"><center>What is `pointblank`? </center></span></h1>
...
## {.transdark background-color="#333333" background-image="images/trans4.png"}


<h1><span style="color: #000000;"><center>Why `pointblank`? </center></span></h1>
...
## {.trans background-color="#ffffff" background-image="images/trans5.png" background-size="80%"}

<h1><span style="color: #ffffff;"><center>`pointblank` Use-Cases</center></span></h1>
...
## {.transdark background-color="#333333" background-image="images/trans6.png"}


<h1><span style="color: #000000;"><center>Questions?</center></span></h1>